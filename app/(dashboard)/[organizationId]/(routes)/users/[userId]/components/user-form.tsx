...
export const UserForm: React.FC<UserFormProps> = ({
  ...
  const description = initialData ? 'Editar una Usuario.' : 'Crear nueva Usuario.';
  const toastMessage = initialData ? 'Usuario actualizada.' : 'Usuario creada.';
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input disabled={loading} placeholder="Nombre del Usuario" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
